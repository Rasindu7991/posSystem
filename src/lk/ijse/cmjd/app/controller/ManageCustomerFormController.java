...
import lk.ijse.cmjd.app.view.util.CustomerTM;
...
public class ManageCustomerFormController{
        ...
        if (tblCustomers.getSelectionModel().isEmpty()) {
            ...
            if (result) {
                new Alert(Alert.AlertType.INFORMATION,
                        "Customer has been saved successfully", ButtonType.OK).showAndWait();
    ...
    @FXML
    void btnReport_OnAction(ActionEvent event) throws JRException, SQLException {
...
//        parms.put("id",txtCustomerId.getText());
//        parms.put("name",txtCustomerName.getText());
//        parms.put("address",txtCustomerAddress.getText());
    ...
    void btnSearch_OnAction(ActionEvent event) {
        try {
            CustomerDTO customerDTO=ManageCustomersBusiness.findCustomer(txtCustomerId.getText());
            if(customerDTO!=null){
